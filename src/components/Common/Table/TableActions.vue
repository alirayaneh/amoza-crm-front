...
<template>
  <Menu as="div" class="relative">
    ...
    >
      <MenuItems
        class="absolute bottom-0 left-8 z-10 mt-1 w-fit origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
      >
        <slot></slot>
      </MenuItems>
    </transition>
