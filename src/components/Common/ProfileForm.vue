...
const telegram_user_id = ref(user.value.telegram_user_id ?? '')
    ...
    <div :class="formClass">
      <div class="flex flex-col items-center gap-12 sm:flex-row">
        <div class="w-full flex-1 space-y-6">
          ...
          <FormInput
            @change="(value) => (telegram_user_id = value)"
            ...
            type="text"
            id="telegram_user_id"
            :errors="errors?.telegram_user_id"
          />
          <span>
            در صورتی که مایل به دریافت ناتیفیکشن در تلگرام هستید لطفا ابتدا در تلگرام به این
            @amoza_seen_bot پیغام دهید و سپس عدد موجود در پاسخ دریافتی را در این قسمت وارد نمایید .
          </span>
