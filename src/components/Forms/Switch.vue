...
<template>
  <SwitchGroup as="div">
    ...
    >
      <span
        :class="[
          toggle ? 'translate-x-0' : 'translate-x-5',
          'pointer-events-none mr-5  inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out'
        ]"
      />
    </Switch>
  </SwitchGroup>
