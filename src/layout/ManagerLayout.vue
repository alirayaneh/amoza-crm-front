...
const adminNavigation = [
  ...
  { name: 'کاربران', to: 'DashboardUsers', icon: UsersIcon },
  { name: 'دپارتمان', to: 'DashboardDepartments', icon: BriefcaseIcon },
  { name: 'مشتریان', to: 'DashboardClients', icon: UserGroupIcon },
  { name: 'سفارشات', to: 'DashboardOrders', icon: ShoppingCartIcon },
  { name: 'وضعیت ها', to: 'DashboardCategories', icon: Squares2X2Icon },
  { name: 'سوالات متداول', to: 'DashboardFaqs', icon: QuestionMarkCircleIcon },
  { name: 'پاسخ های آماده', to: 'DashboardCannedResponses', icon: ChatBubbleLeftRightIcon },
  { name: 'خبرنامه', to: 'DashboardNewsletters', icon: EnvelopeIcon },
  { name: 'تسک ها', to: 'DashboardTickets', icon: TicketIcon },
  { name: 'پروفایل', to: 'DashboardProfile', icon: UserCircleIcon },
  { name: 'پسورد', to: 'DashboardPassword', icon: KeyIcon },
  { name: 'ناتیقیکیشن ها', to: 'DashboardNotifications', icon: BellIcon }
]
